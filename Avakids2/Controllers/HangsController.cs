...
namespace Avakids2.Controllers
{
    public class HangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHang,TenHang,DiaChi,Email,SoDT")] Hang hang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHang,TenHang,DiaChi,Email,SoDT")] Hang hang)
        {
            if (ModelState.IsValid)
            {
